@echo off
set COPYRIGHT=-                   ComfyUI (portable) - Max Smirnov 2024.02                  -
...
echo python -m pip install torch torchvision xformers --extra-index-url https://download.pytorch.org/whl/cu121
